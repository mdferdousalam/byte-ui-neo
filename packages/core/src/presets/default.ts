/**
 * Default Preset
 * Balanced configuration with most commonly used utilities
 * Perfect for: Most projects, dashboards, web apps
 * Bundle impact: ~5-8 KB CSS (standard utilities)
 */

import type { HikmaConfig } from '../types/config';

export const defaultPreset: HikmaConfig = {
  content: [],

  darkMode: 'class',

  theme: {
    // Complete color palette (KlikkFlow colors)
    colors: {
