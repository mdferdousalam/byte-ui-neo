...
Welcome to Hikma UI! This guide will help you get up and running with our modern CSS framework in just a few minutes.

## What is Hikma UI?

Hikma UI is a lightweight, modern CSS framework built with Sass and vanilla JavaScript. It provides:
...
1. Download the latest release from [GitHub](https://github.com/mdferdousalam/hikma-ui/releases)
2. Extract the files
...
Let's create a simple page to see Hikma UI in action:
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>My First Hikma UI Page</title>
    <link rel="stylesheet" href="https://unpkg.com/hikma-ui@1.0.0/dist/hikma-ui.min.css">
</head>
<body>
    <!-- Navigation -->
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="section section-primary text-center p-xl mb-lg">
                    ...
                    <p class="lead">Build beautiful, responsive websites with our modern CSS framework.</p>
                    <div class="btn-group">
                    ...
                    <div class="col-md-6 mb-md">
                        <div class="card h-100">
                            <div class="card-body">
                                ...
                                <p class="card-text">Get started quickly with our comprehensive documentation and examples.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 mb-md">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 text-md-end">
                    <p>&copy; 2024 Hikma UI. All rights reserved.</p>
                </div>
            </div>
        </div>
    </footer>
...
You can customize Hikma UI by overriding CSS variables:
...
:root {
    ...
    /* Typography */
    --hikma-font-family-base: 'Inter', sans-serif;
...
Hikma UI supports all modern browsers:
...
Now that you have Hikma UI set up, here's what you can do next:
...
- 🐛 Report bugs on [GitHub Issues](https://github.com/mdferdousalam/hikma-ui/issues)
- 💬 Ask questions in [GitHub Discussions](https://github.com/mdferdousalam/hikma-ui/discussions)
