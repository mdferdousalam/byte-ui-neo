...
<div class="card text-center">
	<div class="card-body">
		...
		<p class="card-text">
			Passionate about creating amazing user experiences and writing clean code.
		</p>
		<div class="btn-group">
...
<div class="card">
	...
	<div class="card-body">
		...
		<p class="card-text">
			Learn how to create complex layouts using CSS Grid with practical examples
			and best practices.
		</p>
		<div class="d-flex justify-content-between align-items-center">
...
:root {
	...
	/* Card appearance */
	--byte-card-border-width: 1px;
	--byte-card-border-color: #dee2e6;
	--byte-card-border-radius: 0.375rem;
	--byte-card-bg: #fff;
	--byte-card-box-shadow: 0 0.125rem 0.25rem rgba(0, 0, 0, 0.075);

	/* Card header/footer */
	--byte-card-cap-bg: #f8f9fa;
	--byte-card-cap-color: #6c757d;

	/* Card content */
	--byte-card-title-mb: 0.75rem;
	--byte-card-text-mb: 1rem;
}
```
...
<div class="card" role="article" aria-labelledby="card-title-1">
	<div class="card-body">
		...
		<a href="#" class="btn btn--primary" aria-describedby="card-title-1"
			>Learn More</a
		>
	</div>
</div>
