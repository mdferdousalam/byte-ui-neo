...
class ByteModernFeatures {
	...
	initContainerQueries() {
		if (!CSS.supports('container-type: inline-size')) {
			console.warn(
				'Container queries not supported, falling back to ResizeObserver',
			);
				...
				this.shadowRoot.innerHTML = `
                    <style>
                        :host {
                            ...
                            transition: var(--byte-transition-base);
                        }
                        ...
                        .card-header {
                            ...
                            margin-bottom: var(--byte-spacing-md);
                            padding-bottom: var(--byte-spacing-sm);
                        ...
                        .card-title {
                            ...
                            font-weight: var(--byte-font-weight-semibold);
                        ...
                        .card-actions {
                            ...
                            margin-top: var(--byte-spacing-md);
                            padding-top: var(--byte-spacing-md);
				...
				this.shadowRoot.innerHTML = `
                    <style>
                        ...
                        button {
                            ...
                            gap: var(--byte-spacing-xs);
                            background: var(--byte-color-primary);
                            color: white;
                            border: 1px solid var(--byte-color-primary);
                            border-radius: var(--byte-border-radius);
                            ...
                            &:hover {
                                background: var(--byte-color-primary-hover, var(--byte-color-primary));
                                transform: translateY(-1px);
                                box-shadow: var(--byte-shadow-sm);
                            }
                        ...
                        :host([variant="secondary"]) button {
                            background: var(--byte-color-secondary);
                        ...
                        :host([size="lg"]) button {
                            padding: var(--byte-spacing-md) var(--byte-spacing-lg);
                            font-size: var(--byte-font-size-lg);
                        }
                    </style>
				...
				this.shadowRoot.innerHTML = `
                    <style>
                        ...
                        .tooltip.top::before {
                            ...
                            left: 50%;
                            transform: translateX(-50%);
                            border-top-color: var(--byte-border-color-base);
                        }
                        ...
                        .tooltip.bottom::before {
                            ...
                            left: 50%;
                            transform: translateX(-50%);
                            border-bottom-color: var(--byte-border-color-base);
                        }
                        ...
                        .tooltip.left::before {
                            ...
                            top: 50%;
                            transform: translateY(-50%);
                            border-left-color: var(--byte-border-color-base);
                        }
                        ...
                        .tooltip.right::before {
                            ...
                            top: 50%;
                            transform: translateY(-50%);
                            border-right-color: var(--byte-border-color-base);
                        }
                    </style>
		...
		const handleReducedMotionChange = (e) => {
			...
			if (e.matches) {
				...
				document.documentElement.style.setProperty(
					'--byte-transition-base',
					'none',
				);
				document.documentElement.style.setProperty(
					'--byte-transition-fast',
					'none',
				);
			} else {
				// Enable animations
				document.documentElement.style.removeProperty('--byte-transition-base');
				document.documentElement.style.removeProperty('--byte-transition-fast');
			}
		};
